...
import com.neutronstar.ionicapp.domain.Pagamento;
import com.neutronstar.ionicapp.domain.PagamentoComBoleto;
import com.neutronstar.ionicapp.domain.PagamentoComCartao;
...
import com.neutronstar.ionicapp.repositories.EstadoRepository;
...
import com.neutronstar.ionicapp.repositories.ProdutoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "ricardo.agnello.neto@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Cristiane Fernandes", "motoristaricardoagnello@gmail.com", "56135527037", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.addPerfil(Perfil.ADMIN);
		cli2.getTelefones().addAll(Arrays.asList("27558997", "955241258"));

		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida Carioca", "447", "Casa 3", "Moema", "08877025", cli2, c2);
